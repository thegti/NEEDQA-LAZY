...
export class AuthService {
  ...
  ResetPasswordSubmit(req): any {
    return this.httpClient.post<User>(`${this.baseUrl}api/Vendor/ResetPasswordSubmit`, req, this.header);
  }
  ResetPasswordChange(req): any {
    return this.httpClient.post<User>(`${this.baseUrl}api/Vendor/ResetPasswordChange`, req, this.header);
  }
  GetLinkExpiry(req): any {
    return this.httpClient.post<User>(`${this.baseUrl}api/Vendor/GetLinkExpiry`, req, this.header);
  }
