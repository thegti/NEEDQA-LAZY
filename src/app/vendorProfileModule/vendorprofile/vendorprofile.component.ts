...
export class VendorprofileComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.firstFormGroup = this._formBuilder.group({
      ...
      ddlMobileCode: [environment.DefaultCountryCode],
      ddlWhatsappCode: [environment.DefaultCountryCode],
    ...
    this.vendorService.GetSalesLeadSetup(reqObj).subscribe((data: Array<object>) => {
      if (data['Data'] != null) {
        ...
        this.firstFormGroup = this._formBuilder.group({
          ...
          txtKeyword: [''],
          ddlMobileCode: [this.salesLeadList[0].VST_MOBILE_CODE],
          ddlWhatsappCode: [this.salesLeadList[0].VST_WHATSAPP_CODE],
    ...
    this.salesLeadSaveTempObject =
      {
        ...
        "VST_MOBILE_CODE": this.firstFormGroup.value.ddlMobileCode,
        "VST_WHATSAPP_CODE": this.firstFormGroup.value.ddlWhatsappCode
  ...
  GetPhoneCode() {
    ...
    this.apiService.GetCountryCode(reqbody).subscribe((data: Array<object>) => {
      this.countrycode = data['Data'];
      // this.firstFormGroup.controls.ddlMobileCode.setValue(environment.DefaultCountryCode);
      //this.firstFormGroup.controls.ddlWhatsappCode.setValue(environment.DefaultCountryCode);
