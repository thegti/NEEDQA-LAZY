...
import {GetCountryCodeModel} from '../../business-object/CommonDataObject';
...
GetCountryCode(req): any {
   return this.httpClient.post<GetCountryCodeModel>(`${this.baseUrl}api/Common/GetCountryCode`, req, this.header);
}
